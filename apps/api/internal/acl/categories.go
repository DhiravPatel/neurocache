...
var registry = map[string]commandInfo{
	...
	// Phase 14 — multi-agent + governance + ML feedback + ops.
	"AGENT.BB.POST":      {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BB.READ":      {[]string{CatAI, CatRead, CatFast}},
	"AGENT.BB.LIST":      {[]string{CatAI, CatRead, CatFast}},
	"AGENT.BB.CLAIM":     {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BB.RELEASE":   {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BB.CLAIMS":    {[]string{CatAI, CatRead, CatFast}},
	"AGENT.BB.DROP":      {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BB.LIST_RUNS": {[]string{CatAI, CatRead, CatFast}},
	"AGENT.BB.STATS":     {[]string{CatAI, CatRead, CatFast}},

	"AGENT.BUS.REGISTER":   {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BUS.UNREGISTER": {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BUS.SEND":       {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BUS.RECV":       {[]string{CatAI, CatRead, CatFast}},
	"AGENT.BUS.ACK":        {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BUS.AGENTS":     {[]string{CatAI, CatRead, CatFast}},
	"AGENT.BUS.PENDING":    {[]string{CatAI, CatRead, CatFast}},
	"AGENT.BUS.RESET":      {[]string{CatAI, CatWrite, CatFast}},
	"AGENT.BUS.STATS":      {[]string{CatAI, CatRead, CatFast}},

	"PROV.BEGIN":  {[]string{CatAI, CatWrite, CatFast}},
	"PROV.NODE":   {[]string{CatAI, CatWrite, CatFast}},
	"PROV.WHY":    {[]string{CatAI, CatRead, CatFast}},
	"PROV.IMPACT": {[]string{CatAI, CatRead, CatFast}},
	"PROV.ANSWER": {[]string{CatAI, CatRead, CatFast}},
	"PROV.LIST":   {[]string{CatAI, CatRead, CatFast}},
	"PROV.FORGET": {[]string{CatAI, CatWrite, CatFast}},
	"PROV.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"TRUST.RECORD": {[]string{CatAI, CatWrite, CatFast}},
	"TRUST.SCORE":  {[]string{CatAI, CatRead, CatFast}},
	"TRUST.RANK":   {[]string{CatAI, CatRead, CatFast}},
	"TRUST.DECAY":  {[]string{CatAI, CatWrite, CatFast}},
	"TRUST.RESET":  {[]string{CatAI, CatWrite, CatFast}},
	"TRUST.LIST":   {[]string{CatAI, CatRead, CatFast}},
	"TRUST.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"ISOLATE.BIND":     {[]string{CatAI, CatWrite, CatFast}},
	"ISOLATE.UNBIND":   {[]string{CatAI, CatWrite, CatFast}},
	"ISOLATE.CHECK":    {[]string{CatAI, CatRead, CatFast}},
	"ISOLATE.PERMITS":  {[]string{CatAI, CatRead, CatFast}},
	"ISOLATE.LIST_FOR": {[]string{CatAI, CatRead, CatFast}},
	"ISOLATE.EXPECT":   {[]string{CatAI, CatWrite, CatFast}},
	"ISOLATE.AUDIT":    {[]string{CatAI, CatRead, CatFast}},
	"ISOLATE.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"VECSPACE.SAMPLE": {[]string{CatAI, CatWrite, CatFast}},
	"VECSPACE.HEALTH": {[]string{CatAI, CatRead, CatFast}},
	"VECSPACE.RESET":  {[]string{CatAI, CatWrite, CatFast}},
	"VECSPACE.LIST":   {[]string{CatAI, CatRead, CatFast}},
	"VECSPACE.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"PREF.RECORD":       {[]string{CatAI, CatWrite, CatFast}},
	"PREF.STATS":        {[]string{CatAI, CatRead, CatFast}},
	"PREF.EXPORT":       {[]string{CatAI, CatRead, CatFast}},
	"PREF.LIST":         {[]string{CatAI, CatRead, CatFast}},
	"PREF.RESET":        {[]string{CatAI, CatWrite, CatFast}},
	"PREF.STATS_GLOBAL": {[]string{CatAI, CatRead, CatFast}},

	"HANDOFF.SPAWN":        {[]string{CatAI, CatWrite, CatFast}},
	"HANDOFF.REPORT_USAGE": {[]string{CatAI, CatWrite, CatFast}},
	"HANDOFF.RETURN":       {[]string{CatAI, CatWrite, CatFast}},
	"HANDOFF.JOIN":         {[]string{CatAI, CatRead, CatBlocking}},
	"HANDOFF.STATUS":       {[]string{CatAI, CatRead, CatFast}},
	"HANDOFF.CANCEL":       {[]string{CatAI, CatWrite, CatFast}},
	"HANDOFF.LIST":         {[]string{CatAI, CatRead, CatFast}},
	"HANDOFF.FORGET":       {[]string{CatAI, CatWrite, CatFast}},
	"HANDOFF.STATS":        {[]string{CatAI, CatRead, CatFast}},

	"RISK.BUDGET.SET":    {[]string{CatAI, CatWrite, CatFast}},
	"RISK.BUDGET.DEBIT":  {[]string{CatAI, CatWrite, CatFast}},
	"RISK.BUDGET.STATUS": {[]string{CatAI, CatRead, CatFast}},
	"RISK.BUDGET.RESET":  {[]string{CatAI, CatWrite, CatFast}},
	"RISK.BUDGET.LIST":   {[]string{CatAI, CatRead, CatFast}},
	"RISK.BUDGET.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"CFCACHE.PUT":      {[]string{CatAI, CatWrite, CatFast}},
	"CFCACHE.GET":      {[]string{CatAI, CatRead, CatFast}},
	"CFCACHE.VARIANTS": {[]string{CatAI, CatRead, CatFast}},
	"CFCACHE.DIFF":     {[]string{CatAI, CatRead, CatFast}},
	"CFCACHE.FORGET":   {[]string{CatAI, CatWrite, CatFast}},
	"CFCACHE.LIST":     {[]string{CatAI, CatRead, CatFast}},
	"CFCACHE.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"BLAST.SET":    {[]string{CatAI, CatWrite, CatFast}},
	"BLAST.RECORD": {[]string{CatAI, CatWrite, CatFast}},
	"BLAST.REVERT": {[]string{CatAI, CatWrite, CatFast}},
	"BLAST.REPORT": {[]string{CatAI, CatRead, CatFast}},
	"BLAST.STATUS": {[]string{CatAI, CatRead, CatFast}},
	"BLAST.FORGET": {[]string{CatAI, CatWrite, CatFast}},
	"BLAST.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"CAUSAL.APPEND":         {[]string{CatAI, CatWrite, CatFast}},
	"CAUSAL.READ":           {[]string{CatAI, CatRead, CatFast}},
	"CAUSAL.HAPPENS_BEFORE": {[]string{CatAI, CatRead, CatFast}},
	"CAUSAL.CLOCK":          {[]string{CatAI, CatRead, CatFast}},
	"CAUSAL.FORGET":         {[]string{CatAI, CatWrite, CatFast}},
	"CAUSAL.LIST":           {[]string{CatAI, CatRead, CatFast}},
	"CAUSAL.STATS":          {[]string{CatAI, CatRead, CatFast}},

	"SCHEMA.REGISTER": {[]string{CatAI, CatWrite, CatFast}},
	"SCHEMA.DIFF":     {[]string{CatAI, CatRead, CatFast}},
	"SCHEMA.VERSIONS": {[]string{CatAI, CatRead, CatFast}},
	"SCHEMA.FORGET":   {[]string{CatAI, CatWrite, CatFast}},
	"SCHEMA.LIST":     {[]string{CatAI, CatRead, CatFast}},
	"SCHEMA.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"WHATIF.OBSERVE":  {[]string{CatAI, CatWrite, CatFast}},
	"WHATIF.SIMULATE": {[]string{CatAI, CatRead, CatFast}},
	"WHATIF.COMPARE":  {[]string{CatAI, CatRead, CatFast}},
	"WHATIF.ROUTES":   {[]string{CatAI, CatRead, CatFast}},
	"WHATIF.FORGET":   {[]string{CatAI, CatWrite, CatFast}},
	"WHATIF.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"CONSENT.GRANT":    {[]string{CatAI, CatWrite, CatFast}},
	"CONSENT.REVOKE":   {[]string{CatAI, CatWrite, CatFast}},
	"CONSENT.WITHDRAW": {[]string{CatAI, CatWrite, CatFast}},
	"CONSENT.PERMITS":  {[]string{CatAI, CatRead, CatFast}},
	"CONSENT.CHECK":    {[]string{CatAI, CatRead, CatFast}},
	"CONSENT.LIST":     {[]string{CatAI, CatRead, CatFast}},
	"CONSENT.EXPIRING": {[]string{CatAI, CatRead, CatFast}},
	"CONSENT.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"GRAPH.EXTRACT.RUN":     {[]string{CatAI, CatWrite, CatFast}},
	"GRAPH.EXTRACT.LIST":    {[]string{CatAI, CatRead, CatFast}},
	"GRAPH.EXTRACT.SOURCES": {[]string{CatAI, CatRead, CatFast}},
	"GRAPH.EXTRACT.FORGET":  {[]string{CatAI, CatWrite, CatFast}},
	"GRAPH.EXTRACT.STATS":   {[]string{CatAI, CatRead, CatFast}},

	// Phase 15 — provenance, markets, autonomous rules, self-tuning,
	// federated learning, deliberation, approval gates, replay,
	// watermarking, recall, carbon, mode collapse, time-travel.
	"ATTEST.LOG":        {[]string{CatAI, CatWrite, CatFast}},
	"ATTEST.ROOT":       {[]string{CatAI, CatRead, CatSlow}},
	"ATTEST.PROVE":      {[]string{CatAI, CatRead, CatSlow}},
	"ATTEST.VERIFY":     {[]string{CatAI, CatRead, CatFast}},
	"ATTEST.RECEIPT":    {[]string{CatAI, CatRead, CatSlow}},
	"ATTEST.SEAL":       {[]string{CatAI, CatWrite, CatFast}},
	"ATTEST.SIGN":       {[]string{CatAI, CatWrite, CatFast}},
	"ATTEST.VERIFY_SIG": {[]string{CatAI, CatRead, CatFast}},
	"ATTEST.SCAN":       {[]string{CatAI, CatRead, CatFast}},
	"ATTEST.HEAD":       {[]string{CatAI, CatRead, CatFast}},
	"ATTEST.FORGET":     {[]string{CatAI, CatWrite, CatDangerous}},
	"ATTEST.LIST":       {[]string{CatAI, CatRead, CatFast}},
	"ATTEST.STATS":      {[]string{CatAI, CatRead, CatFast}},

	"MARKET.CREATE":  {[]string{CatAI, CatWrite, CatFast}},
	"MARKET.BID":     {[]string{CatAI, CatWrite, CatFast}},
	"MARKET.CLEAR":   {[]string{CatAI, CatWrite, CatFast}},
	"MARKET.LEASE":   {[]string{CatAI, CatWrite, CatFast}},
	"MARKET.RELEASE": {[]string{CatAI, CatWrite, CatFast}},
	"MARKET.PRICE":   {[]string{CatAI, CatRead, CatFast}},
	"MARKET.STARVED": {[]string{CatAI, CatRead, CatFast}},
	"MARKET.STATUS":  {[]string{CatAI, CatRead, CatFast}},
	"MARKET.FORGET":  {[]string{CatAI, CatWrite, CatFast}},
	"MARKET.LIST":    {[]string{CatAI, CatRead, CatFast}},
	"MARKET.STATS":   {[]string{CatAI, CatRead, CatFast}},

	"AUTO.RULE":     {[]string{CatAI, CatWrite, CatFast}},
	"AUTO.UNRULE":   {[]string{CatAI, CatWrite, CatFast}},
	"AUTO.EVALUATE": {[]string{CatAI, CatRead, CatFast}},
	"AUTO.DRYRUN":   {[]string{CatAI, CatRead, CatFast}},
	"AUTO.FIRES":    {[]string{CatAI, CatRead, CatFast}},
	"AUTO.PAUSE":    {[]string{CatAI, CatWrite, CatFast}},
	"AUTO.RESUME":   {[]string{CatAI, CatWrite, CatFast}},
	"AUTO.LIST":     {[]string{CatAI, CatRead, CatFast}},
	"AUTO.GET":      {[]string{CatAI, CatRead, CatFast}},
	"AUTO.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"TUNE.KNOB":      {[]string{CatAI, CatWrite, CatFast}},
	"TUNE.OBJECTIVE": {[]string{CatAI, CatWrite, CatFast}},
	"TUNE.SUGGEST":   {[]string{CatAI, CatRead, CatFast}},
	"TUNE.OBSERVE":   {[]string{CatAI, CatWrite, CatFast}},
	"TUNE.APPLY":     {[]string{CatAI, CatRead, CatFast}},
	"TUNE.STATUS":    {[]string{CatAI, CatRead, CatFast}},
	"TUNE.HISTORY":   {[]string{CatAI, CatRead, CatFast}},
	"TUNE.FORGET":    {[]string{CatAI, CatWrite, CatFast}},
	"TUNE.LIST":      {[]string{CatAI, CatRead, CatFast}},
	"TUNE.STATS":     {[]string{CatAI, CatRead, CatFast}},

	"FED.NODE":   {[]string{CatAI, CatWrite, CatFast}},
	"FED.EXPORT": {[]string{CatAI, CatRead, CatFast}},
	"FED.MERGE":  {[]string{CatAI, CatWrite, CatFast}},
	"FED.SIGNAL": {[]string{CatAI, CatWrite, CatFast}},
	"FED.GET":    {[]string{CatAI, CatRead, CatFast}},
	"FED.PEERS":  {[]string{CatAI, CatRead, CatFast}},
	"FED.FORGET": {[]string{CatAI, CatWrite, CatFast}},
	"FED.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"DEBATE.START":    {[]string{CatAI, CatWrite, CatFast}},
	"DEBATE.CRITIQUE": {[]string{CatAI, CatWrite, CatFast}},
	"DEBATE.REVISE":   {[]string{CatAI, CatWrite, CatFast}},
	"DEBATE.VOTE":     {[]string{CatAI, CatWrite, CatFast}},
	"DEBATE.RESOLVE":  {[]string{CatAI, CatWrite, CatFast}},
	"DEBATE.GET":      {[]string{CatAI, CatRead, CatFast}},
	"DEBATE.LIST":     {[]string{CatAI, CatRead, CatFast}},
	"DEBATE.FORGET":   {[]string{CatAI, CatWrite, CatFast}},
	"DEBATE.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"QUORUM.PROPOSE": {[]string{CatAI, CatWrite, CatFast}},
	"QUORUM.APPROVE": {[]string{CatAI, CatWrite, CatFast}},
	"QUORUM.REJECT":  {[]string{CatAI, CatWrite, CatFast}},
	"QUORUM.COMMIT":  {[]string{CatAI, CatWrite, CatFast}},
	"QUORUM.STATUS":  {[]string{CatAI, CatRead, CatFast}},
	"QUORUM.LIST":    {[]string{CatAI, CatRead, CatFast}},
	"QUORUM.FORGET":  {[]string{CatAI, CatWrite, CatFast}},
	"QUORUM.STATS":   {[]string{CatAI, CatRead, CatFast}},

	"SANDBOX.RECORD":         {[]string{CatAI, CatWrite, CatFast}},
	"SANDBOX.SET_ROUTE":      {[]string{CatAI, CatWrite, CatFast}},
	"SANDBOX.UNSET_ROUTE":    {[]string{CatAI, CatWrite, CatFast}},
	"SANDBOX.SET_PROJECTION": {[]string{CatAI, CatWrite, CatFast}},
	"SANDBOX.RULES":          {[]string{CatAI, CatRead, CatFast}},
	"SANDBOX.REPLAY":         {[]string{CatAI, CatRead, CatSlow}},
	"SANDBOX.SIZE":           {[]string{CatAI, CatRead, CatFast}},
	"SANDBOX.FORGET":         {[]string{CatAI, CatWrite, CatFast}},
	"SANDBOX.LIST":           {[]string{CatAI, CatRead, CatFast}},
	"SANDBOX.STATS":          {[]string{CatAI, CatRead, CatFast}},

	"WMARK.EMBED":   {[]string{CatAI, CatWrite, CatFast}},
	"WMARK.DETECT":  {[]string{CatAI, CatRead, CatFast}},
	"WMARK.KEY":     {[]string{CatAI, CatWrite, CatFast}},
	"WMARK.KEYS":    {[]string{CatAI, CatRead, CatFast}},
	"WMARK.DROPKEY": {[]string{CatAI, CatWrite, CatFast}},
	"WMARK.STATS":   {[]string{CatAI, CatRead, CatFast}},

	"RECALL.REGISTER": {[]string{CatAI, CatWrite, CatFast}},
	"RECALL.MARK":     {[]string{CatAI, CatWrite, CatFast}},
	"RECALL.SCAN":     {[]string{CatAI, CatRead, CatFast}},
	"RECALL.FORGET":   {[]string{CatAI, CatWrite, CatFast}},
	"RECALL.UNMARK":   {[]string{CatAI, CatWrite, CatFast}},
	"RECALL.STATS":    {[]string{CatAI, CatRead, CatFast}},

	"CARBON.INTENSITY": {[]string{CatAI, CatWrite, CatFast}},
	"CARBON.REGION":    {[]string{CatAI, CatWrite, CatFast}},
	"CARBON.CHARGE":    {[]string{CatAI, CatWrite, CatFast}},
	"CARBON.AGGREGATE": {[]string{CatAI, CatRead, CatFast}},
	"CARBON.BUDGET":    {[]string{CatAI, CatWrite, CatFast}},
	"CARBON.OVER":      {[]string{CatAI, CatRead, CatFast}},
	"CARBON.RESET":     {[]string{CatAI, CatWrite, CatFast}},
	"CARBON.STATS":     {[]string{CatAI, CatRead, CatFast}},

	"ENTROPY.OBSERVE": {[]string{CatAI, CatWrite, CatFast}},
	"ENTROPY.REPORT":  {[]string{CatAI, CatRead, CatFast}},
	"ENTROPY.RESET":   {[]string{CatAI, CatWrite, CatFast}},
	"ENTROPY.LIST":    {[]string{CatAI, CatRead, CatFast}},
	"ENTROPY.STATS":   {[]string{CatAI, CatRead, CatFast}},

	"TEMPORAL.SNAPSHOT":   {[]string{CatAI, CatWrite, CatFast}},
	"TEMPORAL.CONTRIBUTE": {[]string{CatAI, CatWrite, CatFast}},
	"TEMPORAL.CLOSE":      {[]string{CatAI, CatWrite, CatFast}},
	"TEMPORAL.AT":         {[]string{CatAI, CatRead, CatFast}},
	"TEMPORAL.GET":        {[]string{CatAI, CatRead, CatFast}},
	"TEMPORAL.DIFF":       {[]string{CatAI, CatRead, CatFast}},
	"TEMPORAL.LIST":       {[]string{CatAI, CatRead, CatFast}},
	"TEMPORAL.FORGET":     {[]string{CatAI, CatWrite, CatFast}},
	"TEMPORAL.STATS":      {[]string{CatAI, CatRead, CatFast}},

	// Phase 16 — settlement, chaos, continual, DR, negotiate, proof,
	// repro, regwatch, egress, license, replay-shadow.
	"ACCT.OPEN":      {[]string{CatAI, CatWrite, CatFast}},
	"ACCT.BALANCE":   {[]string{CatAI, CatRead, CatFast}},
	"ACCT.STATEMENT": {[]string{CatAI, CatRead, CatFast}},
	"ACCT.CLOSE":     {[]string{CatAI, CatWrite, CatFast}},
	"ACCT.LIST":      {[]string{CatAI, CatRead, CatFast}},

	"SETTLE.TXN":       {[]string{CatAI, CatWrite, CatFast}},
	"SETTLE.REVERSE":   {[]string{CatAI, CatWrite, CatFast}},
	"SETTLE.GET":       {[]string{CatAI, CatRead, CatFast}},
	"SETTLE.RECONCILE": {[]string{CatAI, CatRead, CatSlow}},
	"SETTLE.STATS":     {[]string{CatAI, CatRead, CatFast}},

	"CHAOS.INJECT":  {[]string{CatAI, CatWrite, CatDangerous}},
	"CHAOS.REVOKE":  {[]string{CatAI, CatWrite, CatFast}},
	"CHAOS.ACTIVE":  {[]string{CatAI, CatRead, CatFast}},
	"CHAOS.HISTORY": {[]string{CatAI, CatRead, CatFast}},
	"CHAOS.CHECK":   {[]string{CatAI, CatRead, CatFast}},
	"CHAOS.STATS":   {[]string{CatAI, CatRead, CatFast}},

	"CONTINUAL.CHECKPOINT": {[]string{CatAI, CatWrite, CatFast}},
	"CONTINUAL.ANCHOR":     {[]string{CatAI, CatWrite, CatFast}},
	"CONTINUAL.REHEARSE":   {[]string{CatAI, CatWrite, CatFast}},
	"CONTINUAL.DIVERGENCE": {[]string{CatAI, CatRead, CatFast}},
	"CONTINUAL.ROLLBACK":   {[]string{CatAI, CatRead, CatFast}},
	"CONTINUAL.LIST":       {[]string{CatAI, CatRead, CatFast}},
	"CONTINUAL.FORGET":     {[]string{CatAI, CatWrite, CatFast}},
	"CONTINUAL.STATS":      {[]string{CatAI, CatRead, CatFast}},

	"DR.SNAPSHOT":     {[]string{CatAI, CatWrite, CatFast}},
	"DR.CONTRIBUTE":   {[]string{CatAI, CatWrite, CatFast}},
	"DR.SEAL":         {[]string{CatAI, CatWrite, CatFast}},
	"DR.RESTORE_INTO": {[]string{CatAI, CatWrite, CatSlow}},
	"DR.ASSERT":       {[]string{CatAI, CatRead, CatSlow}},
	"DR.PROMOTE":      {[]string{CatAI, CatWrite, CatDangerous}},
	"DR.LIST":         {[]string{CatAI, CatRead, CatFast}},
	"DR.GET":          {[]string{CatAI, CatRead, CatFast}},
	"DR.PAYLOAD":      {[]string{CatAI, CatRead, CatFast}},
	"DR.FORGET":       {[]string{CatAI, CatWrite, CatFast}},
	"DR.STATS":        {[]string{CatAI, CatRead, CatFast}},

	"NEGOTIATE.OPEN":    {[]string{CatAI, CatWrite, CatFast}},
	"NEGOTIATE.OFFER":   {[]string{CatAI, CatWrite, CatFast}},
	"NEGOTIATE.COUNTER": {[]string{CatAI, CatWrite, CatFast}},
	"NEGOTIATE.ACCEPT":  {[]string{CatAI, CatWrite, CatFast}},
	"NEGOTIATE.REJECT":  {[]string{CatAI, CatWrite, CatFast}},
	"NEGOTIATE.WALK":    {[]string{CatAI, CatWrite, CatFast}},
	"NEGOTIATE.GET":     {[]string{CatAI, CatRead, CatFast}},
	"NEGOTIATE.LIST":    {[]string{CatAI, CatRead, CatFast}},
	"NEGOTIATE.FORGET":  {[]string{CatAI, CatWrite, CatFast}},
	"NEGOTIATE.STATS":   {[]string{CatAI, CatRead, CatFast}},

	"PROOF.COMMIT":  {[]string{CatAI, CatWrite, CatFast}},
	"PROOF.PRODUCE": {[]string{CatAI, CatWrite, CatFast}},
	"PROOF.VERIFY":  {[]string{CatAI, CatRead, CatFast}},
	"PROOF.GET":     {[]string{CatAI, CatRead, CatFast}},
	"PROOF.LIST":    {[]string{CatAI, CatRead, CatFast}},
	"PROOF.FORGET":  {[]string{CatAI, CatWrite, CatDangerous}},
	"PROOF.STATS":   {[]string{CatAI, CatRead, CatFast}},

	"REPRO.BUNDLE": {[]string{CatAI, CatWrite, CatFast}},
	"REPRO.USE":    {[]string{CatAI, CatWrite, CatFast}},
	"REPRO.TRACE":  {[]string{CatAI, CatRead, CatFast}},
	"REPRO.HASH":   {[]string{CatAI, CatRead, CatFast}},
	"REPRO.GET":    {[]string{CatAI, CatRead, CatFast}},
	"REPRO.LIST":   {[]string{CatAI, CatRead, CatFast}},
	"REPRO.FORGET": {[]string{CatAI, CatWrite, CatFast}},
	"REPRO.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"REGWATCH.RULE":   {[]string{CatAI, CatWrite, CatFast}},
	"REGWATCH.UNRULE": {[]string{CatAI, CatWrite, CatFast}},
	"REGWATCH.CHECK":  {[]string{CatAI, CatRead, CatFast}},
	"REGWATCH.CROSS":  {[]string{CatAI, CatRead, CatFast}},
	"REGWATCH.RULES":  {[]string{CatAI, CatRead, CatFast}},
	"REGWATCH.STATS":  {[]string{CatAI, CatRead, CatFast}},

	"EGRESS.REGISTER":   {[]string{CatAI, CatWrite, CatFast}},
	"EGRESS.CHECK":      {[]string{CatAI, CatRead, CatFast}},
	"EGRESS.UNREGISTER": {[]string{CatAI, CatWrite, CatFast}},
	"EGRESS.RESET":      {[]string{CatAI, CatWrite, CatFast}},
	"EGRESS.CLUSTERS":   {[]string{CatAI, CatRead, CatFast}},
	"EGRESS.STATS":      {[]string{CatAI, CatRead, CatFast}},

	"LICENSE.TAG":        {[]string{CatAI, CatWrite, CatFast}},
	"LICENSE.UNTAG":      {[]string{CatAI, CatWrite, CatFast}},
	"LICENSE.GET":        {[]string{CatAI, CatRead, CatFast}},
	"LICENSE.MATRIX":     {[]string{CatAI, CatRead, CatFast}},
	"LICENSE.COMPAT_SET": {[]string{CatAI, CatWrite, CatFast}},
	"LICENSE.CHECK":      {[]string{CatAI, CatRead, CatFast}},
	"LICENSE.LIST":       {[]string{CatAI, CatRead, CatFast}},
	"LICENSE.STATS":      {[]string{CatAI, CatRead, CatFast}},

	"REPLAY.SHADOW.ENABLE":     {[]string{CatAI, CatWrite, CatFast}},
	"REPLAY.SHADOW.RECORD":     {[]string{CatAI, CatWrite, CatFast}},
	"REPLAY.SHADOW.DIVERGENCE": {[]string{CatAI, CatRead, CatFast}},
	"REPLAY.SHADOW.DISABLE":    {[]string{CatAI, CatWrite, CatFast}},
