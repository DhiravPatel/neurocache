...
import {
  ...
  Network, ShieldCheck, Flag, Tags, Clock, Logs, BadgeCheck, GitMerge,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/dashboard/prompts",    label: "Prompts",    icon: FileText  },
  { to: "/dashboard/experiments", label: "Experiments", icon: FlaskConical },
  { to: "/dashboard/graph",      label: "Knowledge Graph", icon: Network },
  { to: "/dashboard/grounding",  label: "Grounding", icon: BadgeCheck },
  { to: "/dashboard/coalesce",   label: "Coalescing", icon: GitMerge },
  ...
  { to: "/dashboard/ratelimit",  label: "Rate Limiting", icon: Gauge   },
  { to: "/dashboard/leaderboards", label: "Leaderboards", icon: Trophy },
  { to: "/dashboard/queues",     label: "Queues",     icon: ListChecks },
  { to: "/dashboard/streams",    label: "Streams",    icon: Waves      },
